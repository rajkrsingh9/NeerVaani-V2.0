...
import { Bot, DollarSign, Lightbulb, TrendingUp, Info, MapPin, Package, Store, FileText, ArrowDown, ArrowUp, Minus, BarChart, Scale, ShoppingBasket, Brain, HelpCircle, Briefcase, ChevronsUpDown, Coins, LineChart, PiggyBank, Target as TargetIcon } from 'lucide-react';
